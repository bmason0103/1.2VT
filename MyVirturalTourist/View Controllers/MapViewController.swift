   ...
   override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "collectionViewSegue" {
            if let collectionVC = segue.destination as? collectionViewController {
                collectionVC.latitude = Constants.Coordinate.latitude
                collectionVC.longitude = Constants.Coordinate.longitude
                collectionVC.cityName = cityName
            }
        }
    }
...
extension MapViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, didSelect view: MKAnnotationView) {
        ...
        let pin = (latitude: lat, longitude: lon)
//        {
//            if isEditing {
